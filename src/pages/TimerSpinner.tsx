...
const TimerSpinner = () => {
  return (
    <div className="min-h-screen py-8 md:py-12 container">
      <Helmet>
        <title>Timer Spinner - Countdown with Random Selection | NumberPicker.Live</title>
        <meta name="description" content="Combine a countdown timer with random selection. Perfect for classroom activities, games, and adding suspense to random picks." />
        <meta name="keywords" content="timer spinner, countdown picker, random selection timer, classroom timer, game timer, random picker" />
      </Helmet>
